  ...
  13:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
{
  ...
  2f:	8d 46 04             	lea    0x4(%esi),%eax
  32:	51                   	push   %ecx
  33:	51                   	push   %ecx
  34:	50                   	push   %eax
  35:	ff 76 04             	pushl  0x4(%esi)
  38:	e8 0d 03 00 00       	call   34a <exec>
  ...
  44:	50                   	push   %eax
  45:	50                   	push   %eax
  46:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  49:	50                   	push   %eax
  4a:	8d 45 e0             	lea    -0x20(%ebp),%eax
  4d:	50                   	push   %eax
  4e:	e8 5f 03 00 00       	call   3b2 <waitx>

	printf(1, "Running the command took : \nWait : %d \tRun : %d\t Ret : %d\n", wtime, rtime, ret);
  53:	89 04 24             	mov    %eax,(%esp)
  56:	ff 75 e4             	pushl  -0x1c(%ebp)
  59:	ff 75 e0             	pushl  -0x20(%ebp)
  5c:	68 0c 08 00 00       	push   $0x80c
  61:	6a 01                	push   $0x1
  63:	e8 18 04 00 00       	call   480 <printf>

	exit();
  68:	83 c4 20             	add    $0x20,%esp
  6b:	e8 a2 02 00 00       	call   312 <exit>
		printf(2, "Fork Failed\n");
  70:	56                   	push   %esi
  71:	56                   	push   %esi
  72:	68 d8 07 00 00       	push   $0x7d8
  77:	6a 02                	push   $0x2
  79:	e8 02 04 00 00       	call   480 <printf>
		exit();
  7e:	e8 8f 02 00 00       	call   312 <exit>
			printf(1, "Running simple for loop\n");
  83:	53                   	push   %ebx
  84:	53                   	push   %ebx
  85:	68 e5 07 00 00       	push   $0x7e5
  8a:	6a 01                	push   $0x1
  8c:	e8 ef 03 00 00       	call   480 <printf>
			sleep(200);
  91:	c7 04 24 c8 00 00 00 	movl   $0xc8,(%esp)
  98:	e8 05 03 00 00       	call   3a2 <sleep>
			exit();
  9d:	e8 70 02 00 00       	call   312 <exit>
				printf(2, "Exec failed\n");
  a2:	52                   	push   %edx
  a3:	52                   	push   %edx
  a4:	68 fe 07 00 00       	push   $0x7fe
  a9:	6a 02                	push   $0x2
...
printf(int fd, const char *fmt, ...)
{
 ...
 634:	e9 8f fe ff ff       	jmp    4c8 <printf+0x48>
          s = "(null)";
 639:	bb 48 08 00 00       	mov    $0x848,%ebx
        while(*s != 0){
