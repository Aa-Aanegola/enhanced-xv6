...
int main(int argc, char *argv[])
{
  ...
  13:	a1 e8 0a 00 00       	mov    0xae8,%eax
  18:	85 c0                	test   %eax,%eax
  1a:	7e 57                	jle    73 <main+0x73>
  ...
  1e:	be 64 00 00 00       	mov    $0x64,%esi
  23:	eb 28                	jmp    4d <main+0x4d>
  25:	8d 76 00             	lea    0x0(%esi),%esi
  28:	89 da                	mov    %ebx,%edx
  2a:	83 e2 01             	and    $0x1,%edx
    if (pid == 0)
  2d:	85 c0                	test   %eax,%eax
  2f:	74 68                	je     99 <main+0x99>
    set_priority(100-(j%2),pid); // will only matter for PBS, comment it out if not implemented yet (better priorty for more IO intensive jobs)
  ...
  3c:	50                   	push   %eax
  3d:	e8 c8 03 00 00       	call   40a <set_priority>
  42:	83 c4 10             	add    $0x10,%esp
  for (j = 0; j < number_of_processes; j++)
  45:	39 1d e8 0a 00 00    	cmp    %ebx,0xae8
  4b:	7e 26                	jle    73 <main+0x73>
    int pid = fork();
  4d:	e8 08 03 00 00       	call   35a <fork>
    if (pid < 0)
  ...
  59:	83 c3 01             	add    $0x1,%ebx
      printf(1, "Fork failed\n");
  5c:	68 28 08 00 00       	push   $0x828
  61:	6a 01                	push   $0x1
  63:	e8 68 04 00 00       	call   4d0 <printf>
      continue;
  68:	83 c4 10             	add    $0x10,%esp
  for (j = 0; j < number_of_processes; j++)
  6b:	39 1d e8 0a 00 00    	cmp    %ebx,0xae8
  71:	7f da                	jg     4d <main+0x4d>
    }
  }
  for (j = 0; j < number_of_processes+5; j++)
  73:	83 3d e8 0a 00 00 fc 	cmpl   $0xfffffffc,0xae8
  7a:	7c 18                	jl     94 <main+0x94>
  7c:	31 db                	xor    %ebx,%ebx
  7e:	66 90                	xchg   %ax,%ax
  {
    wait();
  80:	e8 e5 02 00 00       	call   36a <wait>
  for (j = 0; j < number_of_processes+5; j++)
  85:	a1 e8 0a 00 00       	mov    0xae8,%eax
  8a:	83 c3 01             	add    $0x1,%ebx
  8d:	83 c0 04             	add    $0x4,%eax
  90:	39 d8                	cmp    %ebx,%eax
  92:	7d ec                	jge    80 <main+0x80>
      exit();
  94:	e8 c9 02 00 00       	call   362 <exit>
 			if(flag == 0)
  99:	85 d2                	test   %edx,%edx
  9b:	74 36                	je     d3 <main+0xd3>
 				for(volatile int i = 0; i<100000000; i++)
  9d:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  a4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  a7:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
  ac:	7f 13                	jg     c1 <main+0xc1>
  ae:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  b1:	83 c0 01             	add    $0x1,%eax
  b4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  b7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  ba:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
  bf:	7e ed                	jle    ae <main+0xae>
				sleep(200);	
  c1:	83 ec 0c             	sub    $0xc,%esp
  c4:	68 c8 00 00 00       	push   $0xc8
  c9:	e8 24 03 00 00       	call   3f2 <sleep>
  ce:	83 c4 10             	add    $0x10,%esp
  d1:	eb c1                	jmp    94 <main+0x94>
 				sleep(200);
  d3:	83 ec 0c             	sub    $0xc,%esp
  d6:	68 c8 00 00 00       	push   $0xc8
  db:	e8 12 03 00 00       	call   3f2 <sleep>
 				for(volatile int i = 0; i<100000000; i++)
  e0:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  e7:	8b 45 e0             	mov    -0x20(%ebp),%eax
  ea:	83 c4 10             	add    $0x10,%esp
  ed:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
  f2:	7f a0                	jg     94 <main+0x94>
  f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  f8:	8b 45 e0             	mov    -0x20(%ebp),%eax
  fb:	83 c0 01             	add    $0x1,%eax
  fe:	89 45 e0             	mov    %eax,-0x20(%ebp)
 101:	8b 45 e0             	mov    -0x20(%ebp),%eax
 104:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
 109:	7e ed                	jle    f8 <main+0xf8>
 10b:	eb 87                	jmp    94 <main+0x94>
 ...
 439:	85 d2                	test   %edx,%edx
{
 ...
 467:	f7 f1                	div    %ecx
 469:	0f b6 92 3c 08 00 00 	movzbl 0x83c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	e9 8f fe ff ff       	jmp    518 <printf+0x48>
          s = "(null)";
 689:	bb 35 08 00 00       	mov    $0x835,%ebx
        while(*s != 0){
 ...
 6a1:	a1 ec 0a 00 00       	mov    0xaec,%eax
{
 ...
 6dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6df:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
 6e4:	5b                   	pop    %ebx
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 ec 0a 00 00    	mov    0xaec,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	73 47                	jae    7c8 <malloc+0x98>
    ...
    if(p == freep)
 781:	39 05 ec 0a 00 00    	cmp    %eax,0xaec
 ...
 7a6:	e8 f5 fe ff ff       	call   6a0 <free>
  return freep;
 7ab:	8b 15 ec 0a 00 00    	mov    0xaec,%edx
 ...
 7e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 ec 0a 00 00 f0 	movl   $0xaf0,0xaec
 7f7:	0a 00 00 
 7fa:	c7 05 f0 0a 00 00 f0 	movl   $0xaf0,0xaf0
 801:	0a 00 00 
    base.s.size = 0;
 804:	b8 f0 0a 00 00       	mov    $0xaf0,%eax
 809:	c7 05 f4 0a 00 00 00 	movl   $0x0,0xaf4
 810:	00 00 00 
