  ...
  13:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  48:	53                   	push   %ebx
  49:	56                   	push   %esi
  4a:	e8 3b 03 00 00       	call   38a <set_priority>
  4f:	83 c4 10             	add    $0x10,%esp
  52:	83 f8 ff             	cmp    $0xffffffff,%eax
  55:	74 1a                	je     71 <main+0x71>
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb 48 08 00 00       	mov    $0x848,%ebx
        while(*s != 0){
